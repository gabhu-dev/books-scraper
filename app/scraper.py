...
def get_details(url_detail):
    ...
    titulo = soup.select_one(".product_main h1").text
    precio = soup.select_one(".price_color").text.strip()
    disponibilidad = soup.select_one(".availability").text.strip()
    descripcion = soup.select_one("#product_description + p")
